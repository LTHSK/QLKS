...
public class GD_QLTroGiup extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Đây là phần mềm quản lý cửa hàng chạy trên nền tảng Window.");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel4.setText("Nhằm mang đến cho quý khách hàng sự hài lòng nhất cũng như dễ dàng tiếp cận với hệ thống quản lý cửa hàng, chúng tôi đã đưa ra bản hướng dẫn sử dụng hệ thống quản lý khách sạn.");
